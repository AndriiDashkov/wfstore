...
public class WsCatalogKods {
	...
	void putToMaps( int i, int delta ) {
	...
	private void kodInitNewCatalog() {
		...
		if(WsUtils.CATALOG_5_DIGIT) { delta5 = 10000; }
		...
		putToMaps(1309, delta5);
		
		putToMaps(1310, delta5);
		...
		putToMaps(4035, delta5);
		
		putToMaps(4036, delta5);
		
		putToMaps(4037, delta5);
