...
public class WsMainDesktop extends JFrame {
	...
	JMenu m_database = null;
	
	JMenuItem m_exit = null;
	
	JMenuItem m_itemAbout = null;
	
	JMenuItem m_itemManual = null;
	...
	public JMenu createMenuDatabase () {
		...
		m_database = new JMenu(WsUtils.getMenusStrs("databaseMainMenuCaption")); 
		...
		m_database.add(m_itemLoadDatabase);
		
		m_database.add(m_itemNewDatabase);
		
		m_database.add(m_itemImportDatabase);
		
		m_itemImportDatabase.setEnabled(false);
		
		m_database.addSeparator();
		
		m_database.add(m_recentMenu);
		
		m_database.addSeparator();
		
		m_exit = new JMenuItem(WsActionsMngr.get().getAction("wfactionexit"));

		m_database.add(m_exit);
	...
	public JMenu createMenuAbout() {
		...
		m_about = new JMenu(WsUtils.getMenusStrs("abouteMainMenuCaption")); 

		m_itemAbout = new JMenuItem (WsActionsMngr.get().getAction("wsactionabout"));
		
		m_itemManual = new JMenuItem (WsActionsMngr.get().getAction("wsactionmanual"));

		m_about.add(m_itemManual);
		
		m_about.add(m_itemAbout);
	...
	private void setCustomFont() {
		...
		m_recentMenu.setFont(f);
		
		m_about.setFont(f);
		
		m_itemNewDatabase.setFont(f);

		m_itemLoadDatabase.setFont(f);
		
		m_itemImportDatabase.setFont(f);
		
		m_exit.setFont(f);
		
		m_itemAbout.setFont(f);
		
		m_itemManual.setFont(f);
