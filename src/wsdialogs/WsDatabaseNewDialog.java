...
public class WsDatabaseNewDialog extends JDialog {
	...
	public void onOK(ActionEvent e) 
	{
		...
		if(m_path_folder.getText() == null || m_path_folder.getText().isEmpty() ) {
 		    ...
 		    WsUtils.showMessageDialog(getMessagesStrs("folderDataNewEmptyMessage"));
		...
		if( m_name.getText() == null || m_name.getText().isEmpty()) {
			...
			WsUtils.showMessageDialog(getMessagesStrs("nameDataNewEmptyMessage"));
	...
	private String checkPassword() {
		...
		if(null == p ) {
			...
			WsUtils.showMessageDialog(getMessagesStrs("passNotEqualMessage"));
