...
public class WsAutoRashodDialog  extends JDialog  {
	...
	public void onOK(ActionEvent e) {
		...
		int res = WsUtils.showYesNoDialogLong3( getMessagesStrs("startAutoPrihodmessageCaption0"),
				getMessagesStrs("startAutoPrihodmessageCaption1"),
				getMessagesStrs("startAutoPrihodmessageCaption2"));
