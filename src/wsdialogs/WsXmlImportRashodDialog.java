...
import wslong.WsImportXmlRashodLong;
 ...
 *
 */
public class WsXmlImportRashodDialog extends JDialog {
	...
	JLabel m_agent_lable = new JLabel (getGuiStrs("agentRashodNewDialogLabel"));
	
	JProgressBar m_progressBar = new JProgressBar(0, 100);
	
	JLabel m_info_label = new JLabel("");
	
	JCheckBox m_addNewAgents = new JCheckBox(getGuiStrs("checkBXmlAgentCap"));
	...
	public WsXmlImportRashodDialog(JFrame jf, String caption) {
	...
	private void createGUI() {
		...
		panel_check.add(m_addNewAgents);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ( e.getSource() == m_importButton )  {
				...
				if ( 1 == res) {
					...
					WsImportXmlRashodLong cusor = new  WsImportXmlRashodLong(WsXmlImportRashodDialog.this, m_progressBar);
	...
	public boolean isCreateAgentsCheckBoxSelected() {
		
		return m_addNewAgents.isSelected();
