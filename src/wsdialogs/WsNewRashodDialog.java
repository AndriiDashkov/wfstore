...
public class WsNewRashodDialog extends JDialog  {
	...
	public WsNewRashodDialog(JFrame jfrm, WsRashodData dt, String nameFrame) {
		...
		setMinimumSize(new Dimension(screenDim.width - 200, screenDim.height - 200 ));
		
		setMaximumSize(new Dimension(screenDim.width - 50, screenDim.height - 50 ));
	...
	class Forwarder implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ( e.getSource() == m_button_import ) {
				 ...
				 WsExcelImportRashodDialog dialog = new  WsExcelImportRashodDialog(WsNewRashodDialog.this, 
	...
	public void onOK(ActionEvent e) {
		...
		if(m_data.id == -1) {
			...
			String operationMessage = "<html>" + getMessagesStrs("updateRashodFaultWoringDate0") +
					"<br/>" + getMessagesStrs("updateRashodFaultWoringDate1") + "</html>";
...
private JPanel createGrid() {
		...
		for(WsPrihodPartData pData : pData_vec) {
				...
				if (d_exist == null ) {
					...
					if(pData.date.compareTo(getDate()) > 0) {
						   ...
						   WsUtils.showMessageDialogLong(getMessagesStrs("wrongDatePartsInsertedMessage0"),
								   getMessagesStrs("wrongDatePartsInsertedMessage1"));
					...
					WsUtils.showMessageDialogLong(getMessagesStrs("RowWithIdInvoicePartsInsertedMessage0"),
							 getMessagesStrs("RowWithIdInvoicePartsInsertedMessage1") + " " + value);
				}
		}
	...
	private void setCustomFont() {
		...
		m_sklad_table.setRowHeight(m_sklad_table.getRowHeight() + margin_table);
