		...
		try {
			...
			if(importAgents) {
				...
				if(!flag) {
					...
					WsUtils.showMessageDialog(getMessagesStrs("errorAgentsImportCaption"));
			...
			if(importCatalog) {
				...
				if(!flag) {
					...
					WsUtils.showMessageDialog(getMessagesStrs("errorCatalogImportCaption"));
				}
			}
			...
			if(importRest) {
				...
				if(!flag) {
					...
					WsUtils.showMessageDialog(getMessagesStrs("errorRestImportCaption"));
				}
