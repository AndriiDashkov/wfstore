...
public class WsPrihodInRashodDialog extends JDialog {
	...
	public void onOK(ActionEvent e) {
		...
		int res = WsUtils.showYesNoDialogLong( getMessagesStrs("makeAllPrihodIntoRashodMessage0"),
					getMessagesStrs("makeAllPrihodIntoRashodMessage1"));
	...
	private JPanel createGUI() {
		...
		WsGuiTools.setFixedSizeBehavior(m_agent);
		
		WsGuiTools.setFixedSizeBehavior(m_number);
