...
public class  WsRashodForm  extends JPanel {
	    ...
	    JMenuItem m_itemNewRashThreshold = null;
	    ...
	    JMenuItem m_itemXmlImport = null;
		...
		private JPanel createFilterPanel() {
			...
			WsGuiTools.setComponentFixedWidth(m_agentComboBox, 300);
			
			WsGuiTools.setFixedSizeBehavior(m_contractsCombo);
			
			WsGuiTools.setComponentFixedWidth(m_contractsCombo, 300);
			
			WsGuiTools.setFixedSizeBehavior(m_partTypesCombo);
			
			WsGuiTools.setComponentFixedWidth(m_partTypesCombo, 300);
		...
		public Vector<WsRashodData> getSelectedRashodDatas() {
			
			Vector<WsRashodData> dt = new Vector<WsRashodData>();
			
			Vector<Integer> vec = getSelectedRashodIds();
			
			for(Integer i: vec) {
				
				dt.add(WsRashodSqlStatements.getRashodForId(i));
			}
		...
		private void setPopupMenu() {
		   ...
		   m_itemAuto = new JMenuItem(getMenusStrs("autoRashodTableNameMenu"));
		   
		   m_itemNewRashThreshold = new JMenuItem(getGuiStrs("threshRashodTableNameMenu"));
		   
		   m_itemFind = new JMenuItem(getMenusStrs("findTableNameMenu"),
				   WsUtils.get().getIconFromResource("wsfind_16.png"));
		   
		   m_itemPrint = new JMenuItem(getMenusStrs("printNameMenu"),
				   WsUtils.get().getIconFromResource("wsprint.png"));
		   
		   JMenu m_printMenu = new JMenu(getMenusStrs("printNameMenu"));
		   
		   m_printMenu.setIcon( WsUtils.get().getIconFromResource("wsprint16.png"));
		   
		   m_itemNakl = new JMenuItem(getMenusStrs("nakl1NameMenu"));
		   
		   m_itemNakl2 = new JMenuItem(getMenusStrs("nakl2NameMenu"));
		   
		   m_itemNakl3 = new JMenuItem(getMenusStrs("nakl3NameMenu"));
		   ...
		   m_itemRaskladka = new JMenuItem(getMenusStrs("raskladkaRashodTableNameMenu"));
		   
		   m_itemRaskladkaAgents = new JMenuItem(getMenusStrs("raskladkaRashodTableNameMenu2"));
		   
		   JMenu rasklMenu = new JMenu(getMenusStrs("rasklNameMenu"));
		   ...
		   m_itemKartkaZvit = new JMenuItem(getMenusStrs("kartkaZvitRashodTableNameMenu"),
				   WsUtils.get().getIconFromResource("wsimportExcel_16.png"));
		   
		   m_itemPrihodExport = new JMenuItem(getMenusStrs("exportRAshodAsPrihodTableNameMenu"),
				   WsUtils.get().getIconFromResource("wsexportDB_16.png"));
		   
		   m_itemGroupImport = new JMenuItem(getMenusStrs("improtGroupNaklMenu"));
		   
		   m_itemXmlImport = new JMenuItem(getMenusStrs("xmlImpRashodTableNameMenu"),
				   WsUtils.get().getIconFromResource("wsimportExcel_16.png"));
	       ...
	       exportImportMenu.add(m_itemXmlImport);
		   ...
		   m_itemNewRashThreshold.addActionListener( listener);
		   
		   m_itemXmlImport.addActionListener( listener);
	       ...
	       m_popupMenu.add(m_itemNewRashThreshold);
	...
	private class CustomPopupListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
               ...
               else if (menu ==  m_itemNewRashThreshold) {
            	   
            	   WsNewRashodThresholdRestDialog  dialog = new WsNewRashodThresholdRestDialog (WsUtils.get().getMainWindow(),
            			   getGuiStrs("thrRashoDialogWinCaption"));
               ...
               else if (menu == m_itemXmlImport) {
            	   
            	   WsXmlImportRashodDialog dialog = new  WsXmlImportRashodDialog(WsUtils.get().getMainWindow(),
            			   getGuiStrs("xmlRashImpDialogCaption"));
	...
	void deleteSelectedInvoices() {
		...
		if ( 1 == res) {
			...
			if(num > 0) {
		        ...
		        WsUtils.showMessageDialog( getMessagesStrs("deleteRashodsSuccessMessage"));
			}
			else {
	...
	private Vector<WsRashodData> getDataForSelectedNakl() {
		...
		Vector<WsRashodData> dt = getSelectedRashodDatas();
		
		
		if(dt.size() != 1) {
				
			 int res = WsUtils.showYesNoDialog(getMessagesStrs("formZvedNakl"));
	...
	private void showNaklReport1() {
		...
		Vector<WsRashodData> dt = getDataForSelectedNakl();
	...
	private void setCustomFont() {
		...
		m_itemRaskladka.setFont(f);
		
		m_itemRaskladkaAgents.setFont(f);
	       
		m_itemKartkaZvit.setFont(f);
	       
		m_itemGroupImport.setFont(f);
	       
		m_itemPrihodExport.setFont(f);
		
		m_itemXmlImport.setFont(f);
		   
		m_itemNakl2.setFont(f);
		   
		m_itemNakl3.setFont(f);
		
		m_itemNakl.setFont(f);
