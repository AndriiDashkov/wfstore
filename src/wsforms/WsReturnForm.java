...
public class WsReturnForm extends JPanel {
	...
	private void createGUI() {
		...
		WsGuiTools.setComponentFixedWidth(m_kods_combo, 400);
		
		WsGuiTools.setFixedSizeBehavior(m_dates);
		
		WsGuiTools.setComponentFixedWidth(m_dates, 120);
		...
		butPanel2.add(m_backButton);
		
		butPanel2.add(Box.createHorizontalStrut(WsUtils.HOR_STRUT));
		
		butPanel2.add(m_clearButton);
		
		butPanel2.add(Box.createHorizontalGlue());
		...
		WsGuiTools.fixComponentHeightToMin(butPanel2);
