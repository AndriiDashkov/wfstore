...
public class WsExcelImportCatalogPricesDialog extends JDialog {
	...
	private void createGUI() {
		...
		m_title = BorderFactory.createTitledBorder(getGuiStrs("raskladkaImportBorderTitle"));
		
		raskl_panel.setBorder(m_title);
	...
	public WsParseIndicies getIndicesSchema() { return  m_ind_panel.getIndicesSchema(); }
