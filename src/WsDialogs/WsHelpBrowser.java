...
public class WsHelpBrowser extends JFrame 
{
	...
	public void loadTreeItems() {
		...
		WsTreeNode treeNode15 = new WsTreeNode( false, getMenusStrs("m1_5"), "m1_5.html");
		
		treeNode1.add(treeNode15);
		
		WsTreeNode treeNode16 = new WsTreeNode( false, getMenusStrs("m1_6"), "m1_6.html");
		
		treeNode1.add(treeNode16);
		...
		WsTreeNode treeNode39 = new WsTreeNode(false,  getMenusStrs("m3_9"), "m3_9.html");
		
		treeNode3.add(treeNode39);
		...
		WsTreeNode treeNode410 = new WsTreeNode( false, getMenusStrs("m4_10"), "m4_10.html");

		treeNode4.add(treeNode410);
