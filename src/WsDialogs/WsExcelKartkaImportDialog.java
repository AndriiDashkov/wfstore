...
public class WsExcelKartkaImportDialog extends JDialog {
	...
	public void importData() {
		...
		Vector<WsRowData> data_import = WSExcelImport.getDataFromKartkaZvit(  excel_file_name,  schema) ;
		...
		createNakl(data_import, getAgentSqlId(), 
				getSqlStartDate(),  m_number.getText(),  (int) m_people_spinner.getValue());
