...
public class WsGuiTools {
	...
	public static void setComponentPreferredHeight(JComponent c, int height) {
	...
	public static void setComponentMaximumWidth(JComponent c, int width) {
	...
	public static void setFixedSizeBehavior(JComponent c)
	{
		Dimension size = c.getPreferredSize();
	...
	public static Font getCustomFont( ) {
		...
		int fontSize = WsUtils.get().getCustomFontSize();
		...
		if(fontSize == 0) {
			...
			return def.deriveFont((float)(fontSize + def.getSize())).deriveFont(Font.PLAIN);
		}
			
	}
	
	public static void changeFont(Container root, Font f) {
