...
public class WsRashNaklMilitary2Report extends WSReportViewer {
	...
	public WsRashNaklMilitary2Report(JFrame f, String nameFrame,Vector<WsRashodData> data) {
		super(f, nameFrame);
	...
	public String getPrintHtml() {
		...
		for(WsRashodData d_ : m_data) {
			
			data_int.add(d_.id);
		}

		m_vec_parts = WsUtils.mergeSameCodes(WsRashodSqlStatements.getRashodPartsVector( data_int));
		...
		String date_s = "__.__.____";
		
		if(data_int.size() == 1) {
		
			date_s = WsUtils.dateToString( m_data.elementAt(0).date, "dd.MM.yyyy" );
		}
		...
		hS_b.append( "<td align='center' colspan ='2' style=' border-left: 1px solid; border-top: 1px solid ;' nowrap><font size =4>" );
		
		hS_b.append(getGuiStrs("regNomerNaklM2") );
		
		hS_b.append("</font></td>" );
		
		hS_b.append( "<td align='center'  style=' border-left: 1px solid; border-top: 1px solid ;' nowrap><font size =4>" );
		
		hS_b.append(getGuiStrs("nomerArkush") );
		
		hS_b.append("</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;'nowrap><font size =4>" );
		
		hS_b.append(getGuiStrs("nomerDocM2") + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;'nowrap><font size =4>" );
				
		hS_b.append(getGuiStrs("dataDocM2") + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-right: 1px solid; border-top: 1px solid ;' nowrap><font size =4>"); 
				
		hS_b.append(getGuiStrs("pidMetaM2") + "</font></td>" );
		
		hS_b.append( "</tr>");
		
		hS_b.append( "<tr>" );
		
		hS_b.append( "<td align='center' colspan ='2' style=' border-left: 1px solid; border-top: 1px solid; border-bottom: 1px solid;' nowrap><font size =4>" );
		
		if(m_data.size() == 1) { 
		
			hS_b.append(s_n.toString()  + "</font></td>" );
		}
		else {
		...
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>" );
		
		hS_b.append(s_n.toString()  + "</font></td>" );
		
		hS_b.append( "<td align='center'colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>"); 
		
		hS_b.append(date_s + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-right: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>" );
		
		hS_b.append(getGuiStrs("potZabez") + "</font></td>" );
		...
		hS_b.append(getGuiStrs("dataOpM2")+"</font></td>" );
		
		hS_b.append( "<td align='center'  style=' border-left: 1px solid; border-top: 1px solid ;' nowrap><font size =4>" );
				
		hS_b.append(getGuiStrs("slZabezM2") + "</font></td>" );
		
		hS_b.append( "<td align='center'  colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;'nowrap><font size =4>"); 
				
		hS_b.append(getGuiStrs("vanVidM2") + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3'  style=' border-left: 1px solid; border-top: 1px solid ;'nowrap><font size =4>"); 
				
		hS_b.append(getGuiStrs("vanOdM2") + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3'  style=' border-left: 1px solid; border-right: 1px solid; border-top: 1px solid ;' nowrap><font size =4>" );
				
		hS_b.append(getGuiStrs("vidOdM2") + "</font></td>" );
		...
		hS_b.append( "<td align='center' style=' border-left: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>" );
		
		hS_b.append(getGuiStrs("prodM2") + "</font></td>" );
		
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>" );
				
		hS_b.append( d.name  + "</font></td>" );
		
		String agent_name = m_data.elementAt(0).agentName;
		...
		hS_b.append( "<td align='center' colspan ='3' style=' border-left: 1px solid; border-top: 1px solid ;  border-bottom: 1px solid;' nowrap><font size =4>" + agent_name + "</font></td>" );
		...
		hS_b.append( getGuiStrs("vskMaino") );
		
		hS_b.append( "<br />"); 
		
		hS_b.append(getGuiStrs("indexKresl") );
		...
		hS_b.append(  getGuiStrs("vsgo") +"</font></td>"	);
		...
		if(m_p_panel.getP1Person() != null) { hS_b.append(m_p_panel.getP1Person().position); }
		 
		hS_b.append("</font></td><td colspan ='9'></td></tr>");
		
		hS_b.append( "<tr style='border:hidden;'><td  colspan='2'><font size =4>");
		
		if(m_p_panel.getP1Person() != null) { hS_b.append(m_p_panel.getP1Person().rank); }
		 
		hS_b.append("</font></td>");
		
		hS_b.append( "<td align='right' colspan='10'><font size =4>");
		
		if(m_p_panel.getP1Person() != null) { hS_b.append(m_p_panel.getP1Person().name); }
		...
		hS_b.append(getGuiStrs("otrprinyav"));
		
		hS_b.append("</font></td>");
		
		hS_b.append( "<td style='border-bottom: 1px solid;' colspan='5'><font size =4></font></td><td colspan ='4'></td>");
		
		hS_b.append( "<tr align='right' style='border:hidden;'><td  colspan='5'><font size =4>");
		
		hS_b.append(getGuiStrs("pidps"));
				
		hS_b.append( "</td><td  colspan='7'><font size =4></td> </tr>");
		
		hS_b.append( "<tr style='border:hidden;'><td  colspan='4'><font size =4>\"___\"_________ ______ ");
			
		hS_b.append(getGuiStrs("roku"));
		
		hS_b.append( "</td><td  colspan='4'><font size =4></td> </tr>");
	...
	public void exportToExcelFile() {
		...
		try {
	    	...
	    	if(m_p_panel.getP2Person() != null) { 
	    		...
	    		cell0.setCellValue( getGuiStrs("vudav") + " : " + m_p_panel.getP2Person().rank);
	    	}
	    	else {  cell0.setCellValue(getGuiStrs("vudav") + " : "); }
	    	...
	    	if(m_p_panel.getP2Person() != null) { 
	    		...
	    		cell0.setCellValue( m_p_panel.getP2Person().name);
	    	}
	    	else {  cell0.setCellValue(""); }
	    	...
	    	cell0.setCellValue("\"___\"__________  ______ "  + getGuiStrs("roku"));
	...
	private int createExcelHeader( XSSFWorkbook wb, XSSFSheet sheet,  XSSFCreationHelper creationHelper) {
		   ...
		   XSSFCellStyle st0 = getExcelCellStyle(wb, 0, 0, 0, 0, 
			...
			WsPair p  = createExcelApprovePersonHeader( wb, sheet, 
					creationHelper, m_p_panel.getApprovePerson(), 0, 11, HorizontalAlignment.RIGHT);
		    ...
		    String s  = getGuiStrs("naklMilt12") + " " + getGuiStrs("nmbStr") + " " + s_n.toString();
			...
			cl1 = createCell(rowHeader, 3, s_n.toString() , creationHelper); 
			...
			cl1 = createCell(rowHeader, 6, 	agent_name, creationHelper); 
