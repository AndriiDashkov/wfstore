...
public class WsForeignSklads46Report  extends WSReportViewer {
	...
	private void createGui() {
		...
		panel_part.add(Box.createVerticalStrut(WsUtils.VERT_STRUT));
	...
	public void exportToExcelFile() {
		...
		try {
			...
			for(int i = startIndex; i < endIndex; ++i) {
			    ...
			    exportExcelPage(wb , sheet,   m_vec_data.get( m_map_codes.get(page_num)), 1, creationHelper);
	...
	private int createExcelHeader(XSSFWorkbook wb, int initialIndex, XSSFSheet sheet,  WsMoveKodPage p, XSSFCreationHelper creationHelper) {
		...
		XSSFCellStyle  st1 = getExcelCellStyle(wb, 1, 1, 
		   ...
		   createCell(rowHeader0, 0, getGuiStrs("nmbStr"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 1, getGuiStrs("reportBookInDateNameColumn"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 2, getGuiStrs("docNameReportName"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 3, getGuiStrs("d46NomerDoc"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 4, getGuiStrs("d46DataDoc"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 5, getGuiStrs("reportBookNaklPostOder"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 6, getGuiStrs("quantityNameReportColumn"), creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader0, 7, getGuiStrs("quantityNameVibuloReportColumn"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 8,  getGuiStrs("d46PrebDoc"), creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 9, "", creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 10, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader0, 11, "", creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 12, "", creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 13, "", creationHelper).setCellStyle(st1);
		   
		   createCell(rowHeader0, 14, getGuiStrs("d46VCh"), creationHelper).setCellStyle(st1);
		   ...
		   //just to set style
		   for( int i1 = 15; i1 < 14 + vec.size()*6; ++i1) {
			   
			   createCell(rowHeader0, i1, "", creationHelper).setCellStyle(st1);
		   }
		   ...
		   for(int i1 = 0; i1 < 14; ++i1) {
			   ...
			   createCell(rowHeader1, i1, "", creationHelper).setCellStyle(st1);
		   }
		   ...
		   for(int i =0; i < vec.size(); ++i) {
			   ...
			   createCell(rowHeader1, columnIndex, d.name, creationHelper).setCellStyle(st1);
			   
			   createCell(rowHeader1, ++columnIndex, "", creationHelper).setCellStyle(st1);
		   ...
		   createCell(rowHeader2, 0, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 1, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 2, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 3, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 4, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 5, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 6, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 7, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 8, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 9, getGuiStrs("d46KatSortName"), creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 10, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 11, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 12, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader2, 13, "", creationHelper).setCellStyle(st1); 
		   ...
		   for(int i = 0; i < vec.size(); ++i) {
			   ...
			   createCell(rowHeader2, columnIndex, "", creationHelper).setCellStyle(st1); 
			   
			   createCell(rowHeader2, ++columnIndex, getGuiStrs("d46KatSortName"), creationHelper).setCellStyle(st1); 
		   ...
		   createCell(rowHeader3, 0, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 1, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 2, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 3, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 4, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 5, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 6, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 7, "", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 8, getGuiStrs("d46Itogo"), creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 9, "1", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 10, "2", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 11, "3", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 12, "4", creationHelper).setCellStyle(st1); 
		   
		   createCell(rowHeader3, 13, "5", creationHelper).setCellStyle(st1); 
		   ...
		   for(int i = 0; i < vec.size(); ++i) {
			   ...
			   createCell(rowHeader3, ++columnIndex, "1", creationHelper).setCellStyle(st1); 
			   
			   createCell(rowHeader3, ++columnIndex, "2", creationHelper).setCellStyle(st1); 
			   
			   createCell(rowHeader3, ++columnIndex, "3", creationHelper).setCellStyle(st1); 
			   
			   createCell(rowHeader3, ++columnIndex, "4", creationHelper).setCellStyle(st1); 
			   
			   createCell(rowHeader3, ++columnIndex, "5", creationHelper).setCellStyle(st1); 
		 ...
		 for(int i = 1; i < v.size(); ++i) {
			 ...
			 switch(row.indexData) {
					 ...
					 case 2: { //rashod
						 ...
						 if(row.sklad_row) {//rashod sklad not bat
	    	   ...
	    	   if (event.getSource() ==  m_partTypesCombo ) {
	    		   ...
	    		   if(null != d &&  m_map_pages != null) {
		    		   ...
		    		   if(null == page_number) {
		    			   ...
		    			   WsUtils.showMessageDialog(getMessagesStrs("noKodMove46ReportMessage"));
	...
	public void exportExcelPage(XSSFWorkbook wb, XSSFSheet sheet,  WsMoveKodPage p, int page_num, XSSFCreationHelper creationHelper) {
		...
		int row_count = pr.flag;
		
		XSSFRow rowHeader0 = sheet.createRow(++row_count);
		...
		sheet.addMergedRegion(new CellRangeAddress(row_count, row_count,0, 13));
		
		int rowIndex = createExcelHeader(wb, ++row_count, sheet,  m_vec_data.get( m_map_codes.get(page_num)), creationHelper);
		...
		for(int i = 0; i < vec_all_parts.size(); ++i) {
			...
			if(i > 0) { row_vec_prev =  vec_all_parts.elementAt(i -1).row_vec; }
			 ...
			 createCell(rowHeader1, 0,  String.valueOf(i + 1), creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 1,  dateIn, creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 2,  nameRow, creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 3,  naklad_number, creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 4,  dateIn, creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 5,  agentName, creationHelper).setCellStyle(st1);
			 
		     createCell(rowHeader1, 6,  WsUtils.getDF(d_row.in_quantity), creationHelper).setCellStyle(st1);
		     
			 createCell(rowHeader1, 7,  WsUtils.getDF(d_row.out_quantity), creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 8,  WsUtils.getDF(d_row.doc_quantity), creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 9,  "", creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 10, "", creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 11, "", creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 12, "", creationHelper).setCellStyle(st1);
			 
			 createCell(rowHeader1, 13, "", creationHelper).setCellStyle(st1);
			...
			for(int j = 0; j < row_vec.size(); ++j) {
				 ...
				 if( row_vec_prev != null) {
					 ...
					 if(Math.abs(dc.rest - prevRest) <   WsUtils.getRZL()) {
						 ...
						 createCell(rowHeader1, ++cI, "", creationHelper).setCellStyle(st1);
					 }
					 else {
						 createCell(rowHeader1, ++cI, WsUtils.getDF_0(dc.rest), creationHelper).setCellStyle(st1);
						 
					 }
				 }
				 else {
					 
					 createCell(rowHeader1, ++cI, WsUtils.getDF(dc.rest), creationHelper).setCellStyle(st1);
				 }
				//end 'the first 0.0 must be shown' code
