...
public class WsCostRashodControlCellEditor extends AbstractCellEditor implements TableCellEditor, FocusListener, ActionListener {
    ...
    public WsCostRashodControlCellEditor(int index) {
    ...
    private class TextField extends JTextField {
    	...
    	public void setNewValue(double cost) {
    		...
    		m_parent_table.getModel().setValueAt(cost, m_row,  WsCostRashodControlCellEditor.this.m_column_index);
    		
    		((WsRashodPartEditTableModel)m_parent_table.getModel()).fireTableDataChanged();
