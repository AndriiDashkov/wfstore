...
public class WsCostPrihodControlCellEditor extends AbstractCellEditor implements TableCellEditor, FocusListener, ActionListener {
    ...
    public WsCostPrihodControlCellEditor(int index) {
    ...
    private class TextField extends JTextField {
    	...
    	public void setNewValue(double cost) {
    		...
    		m_parent_table.getModel().setValueAt(cost, m_row,  WsCostPrihodControlCellEditor.this.m_column_index);
