...
public class  WsPrihodPartEditTable extends JTable {
	...
	WsNewPrihodDialog m_parent = null;
	
	double m_nds_coeff = WsUtils.getNdsCoeff();
	   
	public  WsPrihodPartEditTable(WsNewPrihodDialog parent) {
		...
		public void actionPerformed(ActionEvent e) {
               ...
               if (menu == m_itemAdd) {
            	   ...
            	   if(d != null &&  Math.abs(d.quantity - d.rest) < 0.0001) {
            		   ...
            		   WsUtils.showMessageDialog(getMessagesStrs("cantDeletePrihodRowRashod"));
            	   }
            	   ...
            	   if(m_model.canDeleteAll()) {
            		   ...
            		   WsUtils.showMessageDialog(getMessagesStrs("cantDeleteAllPrihodRowRashod"));
	...
	private void setPopupMenu() {
		   ...
		   m_itemDeleteAll = new JMenuItem(getMenusStrs("deleteAllTableItemMenu"),
	...
	public void insertPartDataForPartType(WsEventEnable e) {
		...
		if(e.getType() == WsEventEnable.TYPE.NEW_PART_TYPE_PRIHOD_SELECTED ) {
				...
				if(m_parent !=  null) {
					...
					m_parent.insertCostFromContract(vec, m_parent.getContractId());
				}
