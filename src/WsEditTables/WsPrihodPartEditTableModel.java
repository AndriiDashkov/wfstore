   ...
   public int getColumnCount() { 
	...
	void insertKodAndName(WsPartType p, int row) {
		...
		if(Math.abs(dt.quantity - dt.rest) < WsUtils.getRZL()) {
			...
			int res = WsUtils.showYesNoDialogLong3(getMessagesStrs("quesitonChangeKodPrihodRowRashod0"),
					getMessagesStrs("quesitonChangeKodPrihodRowRashod1"),
					getMessagesStrs("quesitonChangeKodPrihodRowRashod2"));
