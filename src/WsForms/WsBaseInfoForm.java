...
public class WsBaseInfoForm extends JPanel {
	...
	private void setCustomFont() {
		...
		m_units_table.getTableHeader().setFont(f);
		
		m_part_types_table.getTableHeader().setFont(f);

		m_agent_types_table.getTableHeader().setFont(f);
		
		m_signs_table.getTableHeader().setFont(f);

		m_info_table.getTableHeader().setFont(f);
		
		m_units_table.setRowHeight(m_units_table.getRowHeight() + margin_table);
		
		m_part_types_table.setRowHeight(m_part_types_table.getRowHeight() + margin_table);

		m_agent_types_table.setRowHeight(m_agent_types_table.getRowHeight() + margin_table);
		
		m_signs_table.setRowHeight(m_signs_table.getRowHeight() + margin_table);

		m_info_table.setRowHeight(m_info_table.getRowHeight() + margin_table);
