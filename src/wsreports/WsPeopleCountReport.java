	...
	public String getPrintHtml(Vector<WsStaffData> vec_all, int start, int end, int page_number) {
		...
		for(int i = start; i <= end; ++i) {
			...
			if(i == end) {
			 ...
			 row_s_b.append("<td nowrap style=' max-width: 250px; text-overflow:ellipsis; overflow: hidden; border-left: 1px solid; border-top: 1px solid ;  border-right: 1px solid ;  ");  
