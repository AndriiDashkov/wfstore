...
public class  WsJoinZsuProdDogsReport  extends WSReportViewer {
		...
		m_genButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	...
            	if(m_html_pages.isEmpty()) {
            		...
            		WsUtils.showMessageDialog(getMessagesStrs("noDataForReportMessage"));
	...
	public Vector<String> generateReport() {
		...
		if(foreign_data == null || foreign_data.isEmpty()) { 
			...
			try {
				...
				try {
					...
					if(wb == null) { 
						...
						WsUtils.showMessageDialog(getMessagesStrs("notExcelFileMissMessage") + " " + 	excel_file_name);
