...
покладіть   папку portable_build  у  зручне   місце  на  вашому  діску  та  запустіть  кліком  
на  файлі wfstore-1.1.0.jar або на файлі скріпта запуску wfstore_start.bat. Папка man повинна 
лежати рядом з цим файлом.
